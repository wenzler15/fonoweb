import {
  require_browser
} from "./chunk-BPQTMNWM.js";
import {
  require_Draft,
  require_immutable
} from "./chunk-2UCDYMBF.js";
    ...
    if (true) {
      (function() {
        ...
        function renderSuspenseBoundary(request, task, props) {
          ...
          var suspendedFallbackTask = createTask(request, fallback3, parentBoundary, boundarySegment, fallbackAbortSet, task.legacyContext, task.context, task.treeContext);
          {
...
// node_modules/draft-convert/esm/convertToHTML.js
...
// node_modules/draft-convert/esm/util/updateMutation.js
...
// node_modules/draft-convert/esm/util/rangeSort.js
var rangeSort_default = function(r1, r2) {
...
// node_modules/draft-convert/esm/encodeBlock.js
var ENTITY_MAP = {
  "&": "&amp;",
  "<": "&lt;",
  ">": "&gt;",
...
var encodeBlock_default = function(block) {
  var blockText = _toConsumableArray(block.text);
  var entities = block.entityRanges.sort(rangeSort_default);
  var styles = block.inlineStyleRanges.sort(rangeSort_default);
  var resultText = "";
  var _loop = function _loop2(index2) {
    var _char = blockText[index2];
    if (ENTITY_MAP[_char] !== void 0) {
      var encoded = ENTITY_MAP[_char];
      var resultIndex = _toConsumableArray(resultText).length;
      resultText += encoded;
      var updateForChar = function updateForChar2(mutation) {
...
// node_modules/draft-convert/esm/util/getElementHTML.js
var import_invariant2 = __toESM(require_browser());
var import_react2 = __toESM(require_react());
var import_server2 = __toESM(require_server_browser());

// node_modules/draft-convert/esm/util/splitReactElement.js
...
function splitReactElement(element) {
  if (VOID_TAGS.indexOf(element.type) !== -1) {
    return import_server.default.renderToStaticMarkup(element);
  }
  var tags = import_server.default.renderToStaticMarkup(import_react.default.cloneElement(element, {}, "\r")).split("\r");
  (0, import_invariant.default)(tags.length > 1, "convertToHTML: Element of type ".concat(element.type, " must render children"));
  (0, import_invariant.default)(tags.length < 3, "convertToHTML: Element of type ".concat(element.type, " cannot use carriage return character"));
  return {
    start: tags[0],
    end: tags[1]
  };
...
function hasChildren(element) {
  return import_react2.default.isValidElement(element) && import_react2.default.Children.count(element.props.children) > 0;
}
function getElementHTML(element) {
  var text = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
  ...
  if (import_react2.default.isValidElement(element)) {
    if (hasChildren(element)) {
      return import_server2.default.renderToStaticMarkup(element);
    }
  ...
  (0, import_invariant2.default)(Object.prototype.hasOwnProperty.call(element, "start") && Object.prototype.hasOwnProperty.call(element, "end"), "convertToHTML: received conversion data without either an HTML string, ReactElement or an object with start/end tags");
  if (text !== null) {
    var _start = element.start, _end = element.end;
    return _start + text + _end;
  }
  return element;
}

// node_modules/draft-convert/esm/util/getElementTagLength.js
var import_react3 = __toESM(require_react());
var getElementTagLength = function getElementTagLength2(element) {
  var type = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "start";
  if (import_react3.default.isValidElement(element)) {
    ...
    var child = import_react3.default.Children.toArray(element.props.children)[0];
    return length + (child && import_react3.default.isValidElement(child) ? getElementTagLength2(child, type) : 0);
  }
...
var getElementTagLength_default = getElementTagLength;

// node_modules/draft-convert/esm/blockEntities.js
var converter = function converter2() {
  var entity = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
  var originalText = arguments.length > 1 ? arguments[1] : void 0;
  return originalText;
};
var blockEntities_default = function(block, entityMap) {
  var entityConverter = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : converter;
  ...
  if (Object.prototype.hasOwnProperty.call(block, "entityRanges") && block.entityRanges.length > 0) {
    ...
    var _loop = function _loop2(index2) {
      var entityRange = entities[index2];
      ...
      var prefixLength = getElementTagLength_default(entityHTML, "start");
      var suffixLength = getElementTagLength_default(entityHTML, "end");
      var updateLaterMutation = function updateLaterMutation2(mutation, mutationIndex) {
        if (mutationIndex > index2 || Object.prototype.hasOwnProperty.call(mutation, "style")) {
          return updateMutation(mutation, entityRange.offset, entityRange.length, converted.length, prefixLength, suffixLength);
        }
        return mutation;
      };
      var updateLaterMutations = function updateLaterMutations2(mutationList) {
...
// node_modules/draft-convert/esm/blockInlineStyles.js
var import_invariant3 = __toESM(require_browser());

// node_modules/draft-convert/esm/util/styleObjectFunction.js
var styleObjectFunction_default = function(object) {
...
// node_modules/draft-convert/esm/util/accumulateFunction.js
var accumulateFunction_default = function(newFn, rest) {
  return function() {
    var newResult = newFn.apply(void 0, arguments);
    if (newResult !== void 0 && newResult !== null) {
      return newResult;
    }
...
// node_modules/draft-convert/esm/default/defaultInlineHTML.js
var import_react4 = __toESM(require_react());
function defaultInlineHTML(style) {
  switch (style) {
    case "BOLD":
      return import_react4.default.createElement("strong", null);
    case "ITALIC":
      return import_react4.default.createElement("em", null);
    case "UNDERLINE":
      return import_react4.default.createElement("u", null);
    case "CODE":
      return import_react4.default.createElement("code", null);
    default:
      return {
        start: "",
        end: ""
...
// node_modules/draft-convert/esm/blockInlineStyles.js
var subtractStyles = function subtractStyles2(original, toRemove) {
...
var popEndingStyles = function popEndingStyles2(styleStack, endingStyles) {
  return endingStyles.reduceRight(function(stack, style) {
    var styleToRemove = stack[stack.length - 1];
    (0, import_invariant3.default)(styleToRemove.style === style.style, "Style ".concat(styleToRemove.style, " to be removed doesn't match expected ").concat(style.style));
    return stack.slice(0, -1);
  }, styleStack);
};
var characterStyles = function characterStyles2(offset, ranges) {
  return ranges.filter(function(range) {
    return offset >= range.offset && offset < range.offset + range.length;
  });
};
var rangeIsSubset = function rangeIsSubset2(firstRange, secondRange) {
...
var latestStyleLast = function latestStyleLast2(s1, s2) {
  var s2endIndex = s2.offset + s2.length;
  var s1endIndex = s1.offset + s1.length;
  return s2endIndex - s1endIndex;
};
var getStylesToReset = function getStylesToReset2(remainingStyles, newStyles) {
  var i = 0;
...
var appendStartMarkup = function appendStartMarkup2(inlineHTML, string, styleRange) {
  return string + getElementHTML(inlineHTML(styleRange.style)).start;
};
var prependEndMarkup = function prependEndMarkup2(inlineHTML, string, styleRange) {
  return getElementHTML(inlineHTML(styleRange.style)).end + string;
};
var defaultCustomInlineHTML = function defaultCustomInlineHTML2(next) {
  return function(style) {
    return next(style);
  };
};
defaultCustomInlineHTML.__isMiddleware = true;
var blockInlineStyles_default = function(rawBlock) {
  var customInlineHTML = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : defaultCustomInlineHTML;
  (0, import_invariant3.default)(rawBlock !== null && rawBlock !== void 0, "Expected raw block to be non-null");
  var inlineHTML;
  if (customInlineHTML.__isMiddleware === true) {
    inlineHTML = customInlineHTML(defaultInlineHTML);
  } else {
    inlineHTML = accumulateFunction_default(styleObjectFunction_default(customInlineHTML), styleObjectFunction_default(defaultInlineHTML));
  }
  var result = "";
  var styleStack = [];
  var sortedRanges = rawBlock.inlineStyleRanges.sort(rangeSort_default);
  ...
  for (var i = 0; i < originalTextArray.length; i++) {
    ...
    (0, import_invariant3.default)(styleStack.length === styles.length, "Character ".concat(i, ": ").concat(styleStack.length - styles.length, " styles left on stack that should no longer be there"));
  }
...
// node_modules/draft-convert/esm/util/blockTypeObjectFunction.js
var blockTypeObjectFunction_default = function(typeObject) {
...
// node_modules/draft-convert/esm/util/getBlockTags.js
var import_invariant4 = __toESM(require_browser());
var import_react5 = __toESM(require_react());
var import_server3 = __toESM(require_server_browser());
function hasChildren2(element) {
  return import_react5.default.isValidElement(element) && import_react5.default.Children.count(element.props.children) > 0;
}
function getBlockTags(blockHTML) {
  (0, import_invariant4.default)(blockHTML !== null && blockHTML !== void 0, "Expected block HTML value to be non-null");
  if (typeof blockHTML === "string") {
    return blockHTML;
  }
  if (import_react5.default.isValidElement(blockHTML)) {
    if (hasChildren2(blockHTML)) {
      return import_server3.default.renderToStaticMarkup(blockHTML);
    }
    return splitReactElement(blockHTML);
  }
  if (Object.prototype.hasOwnProperty.call(blockHTML, "element") && import_react5.default.isValidElement(blockHTML.element)) {
    return Object.assign({}, blockHTML, splitReactElement(blockHTML.element));
  }
  (0, import_invariant4.default)(Object.prototype.hasOwnProperty.call(blockHTML, "start") && Object.prototype.hasOwnProperty.call(blockHTML, "end"), "convertToHTML: received block information without either a ReactElement or an object with start/end tags");
  return blockHTML;
}

// node_modules/draft-convert/esm/util/getNestedBlockTags.js
var import_invariant5 = __toESM(require_browser());
var import_react6 = __toESM(require_react());
function getNestedBlockTags(blockHTML, depth) {
  (0, import_invariant5.default)(blockHTML !== null && blockHTML !== void 0, "Expected block HTML value to be non-null");
  if (typeof blockHTML.nest === "function") {
    var _splitReactElement = splitReactElement(blockHTML.nest(depth)), start = _splitReactElement.start, end = _splitReactElement.end;
    return Object.assign({}, blockHTML, {
      nestStart: start,
      nestEnd: end
    });
  }
  if (import_react6.default.isValidElement(blockHTML.nest)) {
    var _splitReactElement2 = splitReactElement(blockHTML.nest), _start = _splitReactElement2.start, _end = _splitReactElement2.end;
    return Object.assign({}, blockHTML, {
      nestStart: _start,
      nestEnd: _end
    });
  }
  (0, import_invariant5.default)(Object.prototype.hasOwnProperty.call(blockHTML, "nestStart") && Object.prototype.hasOwnProperty.call(blockHTML, "nestEnd"), "convertToHTML: received block information without either a ReactElement or an object with start/end tags");
  return blockHTML;
}

// node_modules/draft-convert/esm/default/defaultBlockHTML.js
var import_react7 = __toESM(require_react());
var ORDERED_LIST_TYPES = ["1", "a", "i"];
var defaultBlockHTML_default = {
  unstyled: import_react7.default.createElement("p", null),
  paragraph: import_react7.default.createElement("p", null),
  "header-one": import_react7.default.createElement("h1", null),
  "header-two": import_react7.default.createElement("h2", null),
  "header-three": import_react7.default.createElement("h3", null),
  "header-four": import_react7.default.createElement("h4", null),
  "header-five": import_react7.default.createElement("h5", null),
  "header-six": import_react7.default.createElement("h6", null),
  "code-block": import_react7.default.createElement("pre", null),
  blockquote: import_react7.default.createElement("blockquote", null),
  "unordered-list-item": {
    element: import_react7.default.createElement("li", null),
    nest: import_react7.default.createElement("ul", null)
  },
  "ordered-list-item": {
    element: import_react7.default.createElement("li", null),
  ...
  media: import_react7.default.createElement("figure", null),
  atomic: import_react7.default.createElement("figure", null)
};

// node_modules/draft-convert/esm/convertToHTML.js
var defaultEntityToHTML = function defaultEntityToHTML2(entity, originalText) {
  return originalText;
};
var convertToHTML = function convertToHTML2(_ref) {
  var _ref$styleToHTML = _ref.styleToHTML, styleToHTML = _ref$styleToHTML === void 0 ? {} : _ref$styleToHTML, _ref$blockToHTML = _ref.blockToHTML, blockToHTML = _ref$blockToHTML === void 0 ? {} : _ref$blockToHTML, _ref$entityToHTML = _ref.entityToHTML, entityToHTML = _ref$entityToHTML === void 0 ? defaultEntityToHTML : _ref$entityToHTML;
  return function(contentState) {
    (0, import_invariant6.default)(contentState !== null && contentState !== void 0, "Expected contentState to be non-null");
    var getBlockHTML;
    if (blockToHTML.__isMiddleware === true) {
      getBlockHTML = blockToHTML(blockTypeObjectFunction_default(defaultBlockHTML_default));
    } else {
      getBlockHTML = accumulateFunction_default(blockTypeObjectFunction_default(blockToHTML), blockTypeObjectFunction_default(defaultBlockHTML_default));
    }
    var rawState = (0, import_draft_js.convertToRaw)(contentState);
    var listStack = [];
    var result = rawState.blocks.map(function(block) {
      var type = block.type, depth = block.depth;
      var closeNestTags = "";
      var openNestTags = "";
      ...
      var innerHTML = blockInlineStyles_default(blockEntities_default(encodeBlock_default(block), rawState.entityMap, entityToHTML), styleToHTML);
      ...
      if (innerHTML.length === 0 && Object.prototype.hasOwnProperty.call(blockHTML, "empty")) {
        if (import_react8.default.isValidElement(blockHTML.empty)) {
          html = import_server4.default.renderToStaticMarkup(blockHTML.empty);
        } else {
...
var convertToHTML_default = function() {
...
// node_modules/draft-convert/esm/convertFromHTML.js
var import_immutable = __toESM(require_immutable());
var import_draft_js2 = __toESM(require_Draft());

// node_modules/draft-convert/esm/util/parseHTML.js
...
function getWhitespaceChunk(inEntity) {
  ...
  return {
    text: SPACE,
    inlines: [(0, import_immutable.OrderedSet)()],
    entities,
    blocks: []
  };
}
function getSoftNewlineChunk(block, depth) {
  ...
  var data = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : (0, import_immutable.Map)();
  if (flat === true) {
    return {
      text: "\r",
      inlines: [(0, import_immutable.OrderedSet)()],
...
function getBlockDividerChunk(block, depth) {
  var data = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : (0, import_immutable.Map)();
  return {
    text: "\r",
    inlines: [(0, import_immutable.OrderedSet)()],
    entities: new Array(1),
...
function baseProcessInlineTag(tag, node) {
  var inlineStyles = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : (0, import_immutable.OrderedSet)();
...
function joinChunks(A, B) {
  ...
  var isJoiningBlocks = A.text !== "\r" && B.text !== "\r";
  var addingNewlineToEmptyBlock = A.text === "\r" && !A.isNewline && B.isNewline;
...
function genFragment(node, inlineStyle, lastList, inBlock, fragmentBlockTags, depth, processCustomInlineStyles, checkEntityNode, checkEntityText, checkBlockType, createEntity, getEntity, mergeEntityData, replaceEntityData, options, inEntity) {
  ...
  if (nodeName === "#text") {
    ...
    var offsetChange = 0;
    var textEntities = checkEntityText(text, createEntity, getEntity, mergeEntityData, replaceEntityData).sort(rangeSort_default);
  ...
  if (typeof blockInfo === "string") {
    blockType = blockInfo;
    blockDataMap = (0, import_immutable.Map)();
  } else {
    blockType = typeof blockInfo === "string" ? blockInfo : blockInfo.type;
    blockDataMap = blockInfo.data ? (0, import_immutable.Map)(blockInfo.data) : (0, import_immutable.Map)();
  }
    ...
    if (sibling && fragmentBlockTags.indexOf(nodeName) >= 0 && inBlock) {
      ...
      if (newBlockInfo !== false) {
        ...
        if (typeof newBlockInfo === "string") {
          ...
          newBlockData = (0, import_immutable.Map)();
        } else {
          newBlockType = newBlockInfo.type || getBlockTypeForTag(nodeName, lastList);
          newBlockData = newBlockInfo.data ? (0, import_immutable.Map)(newBlockInfo.data) : (0, import_immutable.Map)();
        }
  ...
  if (newBlock) {
    chunk = joinChunks(chunk, getBlockDividerChunk(nextBlockType, depth, (0, import_immutable.Map)()), options.flat);
  }
  return chunk;
}
function getChunkForHTML(html, processCustomInlineStyles, checkEntityNode, checkEntityText, checkBlockType, createEntity, getEntity, mergeEntityData, replaceEntityData, options, DOMBuilder) {
  ...
  var chunk = genFragment(safeBody, (0, import_immutable.OrderedSet)(), "ul", null, workingBlocks, -1, processCustomInlineStyles, checkEntityNode, checkEntityText, checkBlockType, createEntity, getEntity, mergeEntityData, replaceEntityData, options);
...
function convertFromHTMLtoContentBlocks(html, processCustomInlineStyles, checkEntityNode, checkEntityText, checkBlockType, createEntity, getEntity, mergeEntityData, replaceEntityData, options, DOMBuilder, generateKey) {
  ...
  return chunk.text.split("\r").map(function(textBlock, blockIndex) {
    ...
    var characterList = (0, import_immutable.List)(inlines.map(function(style, entityIndex) {
      var data = {
        style,
        entity: null
      };
      ...
      return import_draft_js2.CharacterMetadata.create(data);
    }));
    start = end + 1;
    return new import_draft_js2.ContentBlock({
      key: generateKey(),
...
var convertFromHTML = function convertFromHTML2(_ref2) {
  ...
  return function(html) {
    ...
    var generateKey = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : import_draft_js2.genKey;
    var contentState = import_draft_js2.ContentState.createFromText("");
    var createEntityWithContentState = function createEntityWithContentState2() {
      ...
      return import_draft_js2.Entity.create.apply(import_draft_js2.Entity, arguments);
    };
    var getEntityWithContentState = function getEntityWithContentState2() {
      ...
      return import_draft_js2.Entity.get.apply(import_draft_js2.Entity, arguments);
    };
    var mergeEntityDataWithContentState = function mergeEntityDataWithContentState2() {
      ...
      import_draft_js2.Entity.mergeData.apply(import_draft_js2.Entity, arguments);
    };
    var replaceEntityDataWithContentState = function replaceEntityDataWithContentState2() {
      ...
      import_draft_js2.Entity.replaceData.apply(import_draft_js2.Entity, arguments);
    };
    ...
    var blockMap = import_draft_js2.BlockMapBuilder.createFromArray(contentBlocks);
    var firstBlockKey = contentBlocks[0].getKey();
    return contentState.merge({
      blockMap,
      selectionBefore: import_draft_js2.SelectionState.createEmpty(firstBlockKey),
      selectionAfter: import_draft_js2.SelectionState.createEmpty(firstBlockKey)
    });
  };
};
var convertFromHTML_default = function() {
...
export {
  convertFromHTML_default as convertFromHTML,
  convertToHTML_default as convertToHTML,
  parseHTML
};
/**
 * @license React
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=draft-convert.js.map
