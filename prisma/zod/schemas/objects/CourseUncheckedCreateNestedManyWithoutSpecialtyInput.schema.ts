...
const Schema: z.ZodType<Prisma.CourseUncheckedCreateNestedManyWithoutSpecialtyInput> =
	z.union([
		z
			.object({
				create: z
...
export const CourseUncheckedCreateNestedManyWithoutSpecialtyInputObjectSchema =
	Schema
