...
const Schema: z.ZodType<Prisma.DoctorPatientUncheckedUpdateManyWithoutAssignedByNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const DoctorPatientUncheckedUpdateManyWithoutAssignedByNestedInputObjectSchema =
	Schema
