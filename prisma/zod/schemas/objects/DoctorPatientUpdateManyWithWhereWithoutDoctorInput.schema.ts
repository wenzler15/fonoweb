...
const Schema: z.ZodType<Prisma.DoctorPatientUpdateManyWithWhereWithoutDoctorInput> =
	z
		.object({
...
export const DoctorPatientUpdateManyWithWhereWithoutDoctorInputObjectSchema =
	Schema
