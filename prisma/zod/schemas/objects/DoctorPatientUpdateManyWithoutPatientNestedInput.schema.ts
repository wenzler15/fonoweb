...
const Schema: z.ZodType<Prisma.DoctorPatientUpdateManyWithoutPatientNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const DoctorPatientUpdateManyWithoutPatientNestedInputObjectSchema =
	Schema
