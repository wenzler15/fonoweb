...
const Schema: z.ZodType<Prisma.DoctorUncheckedUpdateWithoutEvaluationsInput> = z
	.object({
		id: z
			.union([
				z.string(),
...
export const DoctorUncheckedUpdateWithoutEvaluationsInputObjectSchema = Schema
