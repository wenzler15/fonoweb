...
const Schema: z.ZodType<Prisma.EvaluationCreateNestedManyWithoutPatientInput> =
	z.union([
		z
			.object({
				create: z
...
export const EvaluationCreateNestedManyWithoutPatientInputObjectSchema = Schema
