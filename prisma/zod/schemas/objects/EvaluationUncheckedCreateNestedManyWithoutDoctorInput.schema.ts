...
const Schema: z.ZodType<Prisma.EvaluationUncheckedCreateNestedManyWithoutDoctorInput> =
	z.union([
		z
			.object({
				create: z
...
export const EvaluationUncheckedCreateNestedManyWithoutDoctorInputObjectSchema =
	Schema
