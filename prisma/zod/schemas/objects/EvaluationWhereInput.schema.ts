...
const Schema: z.ZodType<Prisma.EvaluationWhereInput> = z
	.object({
		AND: z
			.union([
				z.lazy(() => EvaluationWhereInputObjectSchema),
				z.lazy(() => EvaluationWhereInputObjectSchema).array(),
			])
			.optional(),
		OR: z
			.lazy(() => EvaluationWhereInputObjectSchema)
			.array()
			.optional(),
		NOT: z
			.union([
...
export const EvaluationWhereInputObjectSchema = Schema
