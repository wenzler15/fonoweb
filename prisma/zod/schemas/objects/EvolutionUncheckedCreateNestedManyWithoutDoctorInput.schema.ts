...
const Schema: z.ZodType<Prisma.EvolutionUncheckedCreateNestedManyWithoutDoctorInput> =
	z.union([
		z
			.object({
				create: z
...
export const EvolutionUncheckedCreateNestedManyWithoutDoctorInputObjectSchema =
	Schema
