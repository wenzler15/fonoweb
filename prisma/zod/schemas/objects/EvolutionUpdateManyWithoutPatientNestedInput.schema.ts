...
const Schema: z.ZodType<Prisma.EvolutionUpdateManyWithoutPatientNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const EvolutionUpdateManyWithoutPatientNestedInputObjectSchema = Schema
