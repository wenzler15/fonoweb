...
const Schema: z.ZodType<Prisma.EvolutionUpdateManyWithoutSpecialtyNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const EvolutionUpdateManyWithoutSpecialtyNestedInputObjectSchema = Schema
