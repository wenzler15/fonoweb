...
const Schema: z.ZodType<Prisma.ExerciseCreateNestedManyWithoutSpecialtyInput> =
	z.union([
		z
			.object({
				create: z
...
export const ExerciseCreateNestedManyWithoutSpecialtyInputObjectSchema = Schema
