...
const Schema: z.ZodType<Prisma.ExerciseUpdateManyWithoutSpecialtyNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const ExerciseUpdateManyWithoutSpecialtyNestedInputObjectSchema = Schema
