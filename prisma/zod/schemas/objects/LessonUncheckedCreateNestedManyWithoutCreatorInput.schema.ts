...
const Schema: z.ZodType<Prisma.LessonUncheckedCreateNestedManyWithoutCreatorInput> =
	z.union([
		z
			.object({
				create: z
...
export const LessonUncheckedCreateNestedManyWithoutCreatorInputObjectSchema =
	Schema
