...
const Schema: z.ZodType<Prisma.LessonUncheckedUpdateManyWithoutCreatorNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const LessonUncheckedUpdateManyWithoutCreatorNestedInputObjectSchema =
	Schema
