...
const Schema: z.ZodType<Prisma.LessonVideoCreateNestedManyWithoutLessonInput> =
	z.union([
		z
			.object({
				create: z
...
export const LessonVideoCreateNestedManyWithoutLessonInputObjectSchema = Schema
