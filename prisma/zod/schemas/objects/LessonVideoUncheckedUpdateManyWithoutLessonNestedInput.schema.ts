...
const Schema: z.ZodType<Prisma.LessonVideoUncheckedUpdateManyWithoutLessonNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const LessonVideoUncheckedUpdateManyWithoutLessonNestedInputObjectSchema =
	Schema
