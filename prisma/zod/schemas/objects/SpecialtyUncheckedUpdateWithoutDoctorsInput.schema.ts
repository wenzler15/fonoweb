...
const Schema: z.ZodType<Prisma.SpecialtyUncheckedUpdateWithoutDoctorsInput> = z
	.object({
		id: z
			.union([
				z.string(),
...
export const SpecialtyUncheckedUpdateWithoutDoctorsInputObjectSchema = Schema
