...
const Schema: z.ZodType<Prisma.SpecialtyUncheckedUpdateWithoutTemplatesInput> =
	z
		.object({
			id: z
				.union([
...
export const SpecialtyUncheckedUpdateWithoutTemplatesInputObjectSchema = Schema
