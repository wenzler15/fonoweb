...
const Schema: z.ZodType<Prisma.TemplateUncheckedUpdateManyWithoutTemplatesInput> =
	z
		.object({
			id: z
				.union([
...
export const TemplateUncheckedUpdateManyWithoutTemplatesInputObjectSchema =
	Schema
