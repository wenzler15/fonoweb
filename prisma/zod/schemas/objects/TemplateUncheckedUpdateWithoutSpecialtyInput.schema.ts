...
const Schema: z.ZodType<Prisma.TemplateUncheckedUpdateWithoutSpecialtyInput> = z
	.object({
		id: z
			.union([
				z.string(),
...
export const TemplateUncheckedUpdateWithoutSpecialtyInputObjectSchema = Schema
