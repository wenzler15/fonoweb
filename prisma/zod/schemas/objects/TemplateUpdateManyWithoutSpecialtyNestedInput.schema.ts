...
const Schema: z.ZodType<Prisma.TemplateUpdateManyWithoutSpecialtyNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const TemplateUpdateManyWithoutSpecialtyNestedInputObjectSchema = Schema
