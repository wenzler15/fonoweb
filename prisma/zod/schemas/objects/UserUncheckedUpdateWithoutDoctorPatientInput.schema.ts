...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutDoctorPatientInput> = z
	.object({
		id: z
			.union([
				z.string(),
...
export const UserUncheckedUpdateWithoutDoctorPatientInputObjectSchema = Schema
