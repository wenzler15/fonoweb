...
const Schema: z.ZodType<Prisma.WatchedVideoUncheckedUpdateManyWithoutUserNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const WatchedVideoUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
	Schema
