...
const Schema: z.ZodType<Prisma.WatchedVideoUncheckedUpdateManyWithoutVideoNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const WatchedVideoUncheckedUpdateManyWithoutVideoNestedInputObjectSchema =
	Schema
