...
import { Container, TextNavBar, UserContainer, UserContainerButton } from "./styles";
  ...
  return (
    <Container>
      <div>
        ...
        <TextNavBar onClick={() => navigate("/doctorexercises")}>Exercicios</TextNavBar>
      </div>
      ...
      <UserContainer>
        ...
        <Drawer anchor="top" open={isDrawerVisible} onClose={handleToggleDrawer}>
