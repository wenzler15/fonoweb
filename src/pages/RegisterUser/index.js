          ...
          <Form>
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formGridName">
                <Form.Label style={{ fontWeight: "bold", color: "#1E3354" }}>
                  Nome completo
                </Form.Label>
                <Form.Control
            ...
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formGridCrfa">
                <Form.Label style={{ fontWeight: "bold", color: "#1E3354" }}>
                  Anexar CRFA ou Comprovante da faculdade
                </Form.Label>
                <Form.Control
                  type="file"
            ...
            <Row className="mb-3">
              <Form.Group as={Col} controlId="formGridEspecialidade">
                ...
                >
                  ...
                  <option value="Motricidade Orofacial">
                    {" "}
                  ...
                  <option value="Fonoaudiologia Educacional">
                    {" "}
                    Fonoaudiologia Educacional{" "}
                  </option>
                  <option value="Gerontologia"> Gerontologia </option>
                  <option value="Fonoaudiologia Neurofuncional">
                    {" "}
                    Fonoaudiologia Neurofuncional{" "}
                  </option>
                  <option value="Fonoaudiologia do Trabalho">
                    {" "}
                    Fonoaudiologia do Trabalho{" "}
                  </option>
                  <option value="Neuropsicologia"> Neuropsicologia </option>
                  <option value="Fluência"> Fluência </option>
                  <option value="Perícia Fonoaudiológica">
                    {" "}
                    Perícia Fonoaudiológica{" "}
                  </option>
                  <option value="Fonoaudiologia Hospitalar">
                    {" "}
