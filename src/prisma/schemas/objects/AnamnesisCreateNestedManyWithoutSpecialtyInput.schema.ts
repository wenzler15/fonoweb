...
const Schema: z.ZodType<Prisma.AnamnesisCreateNestedManyWithoutSpecialtyInput> =
	z.union([
		z
			.object({
				create: z
...
export const AnamnesisCreateNestedManyWithoutSpecialtyInputObjectSchema = Schema
