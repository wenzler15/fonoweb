...
const Schema: z.ZodType<Prisma.AnamnesisUncheckedCreateNestedManyWithoutPatientInput> =
	z.union([
		z
			.object({
				create: z
...
export const AnamnesisUncheckedCreateNestedManyWithoutPatientInputObjectSchema =
	Schema
