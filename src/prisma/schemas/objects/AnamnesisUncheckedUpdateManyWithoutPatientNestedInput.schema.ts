...
const Schema: z.ZodType<Prisma.AnamnesisUncheckedUpdateManyWithoutPatientNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const AnamnesisUncheckedUpdateManyWithoutPatientNestedInputObjectSchema =
	Schema
