...
const Schema: z.ZodType<Prisma.AnamnesisUncheckedUpdateManyWithoutSpecialtyNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const AnamnesisUncheckedUpdateManyWithoutSpecialtyNestedInputObjectSchema =
	Schema
