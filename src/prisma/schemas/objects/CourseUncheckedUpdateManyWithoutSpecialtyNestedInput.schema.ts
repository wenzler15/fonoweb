...
const Schema: z.ZodType<Prisma.CourseUncheckedUpdateManyWithoutSpecialtyNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const CourseUncheckedUpdateManyWithoutSpecialtyNestedInputObjectSchema =
	Schema
