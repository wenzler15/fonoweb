...
const Schema: z.ZodType<Prisma.DoctorPatientUncheckedCreateNestedManyWithoutAssignedByInput> =
	z.union([
		z
			.object({
				create: z
...
export const DoctorPatientUncheckedCreateNestedManyWithoutAssignedByInputObjectSchema =
	Schema
