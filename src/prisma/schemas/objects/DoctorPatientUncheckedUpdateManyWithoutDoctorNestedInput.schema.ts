...
const Schema: z.ZodType<Prisma.DoctorPatientUncheckedUpdateManyWithoutDoctorNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const DoctorPatientUncheckedUpdateManyWithoutDoctorNestedInputObjectSchema =
	Schema
