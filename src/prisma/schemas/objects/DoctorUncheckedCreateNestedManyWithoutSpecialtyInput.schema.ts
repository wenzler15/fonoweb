...
const Schema: z.ZodType<Prisma.DoctorUncheckedCreateNestedManyWithoutSpecialtyInput> =
	z.union([
		z
			.object({
				create: z
...
export const DoctorUncheckedCreateNestedManyWithoutSpecialtyInputObjectSchema =
	Schema
