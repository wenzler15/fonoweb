...
const Schema: z.ZodType<Prisma.DoctorUncheckedCreateWithoutAppointmentsInput> =
	z
		.object({
...
export const DoctorUncheckedCreateWithoutAppointmentsInputObjectSchema = Schema
