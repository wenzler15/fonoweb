...
const Schema: z.ZodType<Prisma.DoctorUncheckedCreateWithoutDoctorPatientInput> =
	z
		.object({
...
export const DoctorUncheckedCreateWithoutDoctorPatientInputObjectSchema = Schema
