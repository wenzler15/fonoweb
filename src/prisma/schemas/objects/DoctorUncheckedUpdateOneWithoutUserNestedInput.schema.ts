...
const Schema: z.ZodType<Prisma.DoctorUncheckedUpdateOneWithoutUserNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const DoctorUncheckedUpdateOneWithoutUserNestedInputObjectSchema = Schema
