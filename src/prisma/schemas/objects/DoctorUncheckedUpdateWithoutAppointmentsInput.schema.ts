...
const Schema: z.ZodType<Prisma.DoctorUncheckedUpdateWithoutAppointmentsInput> =
	z
		.object({
			id: z
				.union([
...
export const DoctorUncheckedUpdateWithoutAppointmentsInputObjectSchema = Schema
