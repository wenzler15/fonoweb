...
const Schema: z.ZodType<Prisma.DoctorUncheckedUpdateWithoutEvolutionsInput> = z
	.object({
		id: z
			.union([
				z.string(),
...
export const DoctorUncheckedUpdateWithoutEvolutionsInputObjectSchema = Schema
