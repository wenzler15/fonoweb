...
const Schema: z.ZodType<Prisma.EvaluationUncheckedUpdateManyWithoutDoctorNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const EvaluationUncheckedUpdateManyWithoutDoctorNestedInputObjectSchema =
	Schema
