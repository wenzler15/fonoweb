...
const Schema: z.ZodType<Prisma.EvaluationUpdateManyWithWhereWithoutSpecialtyInput> =
	z
		.object({
...
export const EvaluationUpdateManyWithWhereWithoutSpecialtyInputObjectSchema =
	Schema
