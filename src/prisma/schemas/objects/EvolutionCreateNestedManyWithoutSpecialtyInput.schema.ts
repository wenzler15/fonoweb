...
const Schema: z.ZodType<Prisma.EvolutionCreateNestedManyWithoutSpecialtyInput> =
	z.union([
		z
			.object({
				create: z
...
export const EvolutionCreateNestedManyWithoutSpecialtyInputObjectSchema = Schema
