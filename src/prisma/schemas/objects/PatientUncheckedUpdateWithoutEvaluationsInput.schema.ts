...
const Schema: z.ZodType<Prisma.PatientUncheckedUpdateWithoutEvaluationsInput> =
	z
		.object({
			id: z
				.union([
...
export const PatientUncheckedUpdateWithoutEvaluationsInputObjectSchema = Schema
