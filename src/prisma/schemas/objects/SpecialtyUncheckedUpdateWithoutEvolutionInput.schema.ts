...
const Schema: z.ZodType<Prisma.SpecialtyUncheckedUpdateWithoutEvolutionInput> =
	z
		.object({
			id: z
				.union([
...
export const SpecialtyUncheckedUpdateWithoutEvolutionInputObjectSchema = Schema
