...
const Schema: z.ZodType<Prisma.TemplateUncheckedCreateNestedManyWithoutDoctorInput> =
	z.union([
		z
			.object({
				create: z
...
export const TemplateUncheckedCreateNestedManyWithoutDoctorInputObjectSchema =
	Schema
