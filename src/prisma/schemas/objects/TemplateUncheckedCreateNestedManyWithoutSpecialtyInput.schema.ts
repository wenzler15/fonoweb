...
const Schema: z.ZodType<Prisma.TemplateUncheckedCreateNestedManyWithoutSpecialtyInput> =
	z.union([
		z
			.object({
				create: z
...
export const TemplateUncheckedCreateNestedManyWithoutSpecialtyInputObjectSchema =
	Schema
