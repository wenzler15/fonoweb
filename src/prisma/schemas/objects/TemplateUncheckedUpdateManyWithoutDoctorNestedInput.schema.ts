...
const Schema: z.ZodType<Prisma.TemplateUncheckedUpdateManyWithoutDoctorNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const TemplateUncheckedUpdateManyWithoutDoctorNestedInputObjectSchema =
	Schema
