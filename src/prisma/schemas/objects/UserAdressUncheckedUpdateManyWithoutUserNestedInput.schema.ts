...
const Schema: z.ZodType<Prisma.UserAdressUncheckedUpdateManyWithoutUserNestedInput> =
	z.union([
		z
			.object({
				create: z
...
export const UserAdressUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
	Schema
