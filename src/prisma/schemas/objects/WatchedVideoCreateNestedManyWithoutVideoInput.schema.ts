...
const Schema: z.ZodType<Prisma.WatchedVideoCreateNestedManyWithoutVideoInput> =
	z.union([
		z
			.object({
				create: z
...
export const WatchedVideoCreateNestedManyWithoutVideoInputObjectSchema = Schema
