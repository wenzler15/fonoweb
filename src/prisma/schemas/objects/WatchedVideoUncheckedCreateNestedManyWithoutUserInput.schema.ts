...
const Schema: z.ZodType<Prisma.WatchedVideoUncheckedCreateNestedManyWithoutUserInput> =
	z.union([
		z
			.object({
				create: z
...
export const WatchedVideoUncheckedCreateNestedManyWithoutUserInputObjectSchema =
	Schema
